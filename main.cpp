...
int mainNonLib()
{
	UIManager UI;
	//UI_SSAO
	if (!UI.create(900, 650, "nihilnauts", 120, UI_SOBEL | UI_SSAO | UI_SHADOW, "windowFragment2"))
	{
	...
	*/
	...
	for (int i = 0; i < 10; i++)
	{
		...
		obj->transform.setRotation(0, (rand() % 360), 0);
